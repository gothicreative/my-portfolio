  ...
  const timelineEvents = [
    {
      ...
      achievements: [
        'Built 5+ production applications serving thousands of users',
    ...
    },
    {
      ...
      achievements: [
        'Delivered 6+ client projects with 98% satisfaction rate',
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              A journey through professional roles, high-impact projects, and technical milestones has shaped my expertise in full-stack development and digital creativity.<br/> <br/>
              From my foundations in Computer Engineering to mastering the MERN stack & React Native, I engineer scalable, performant applications that bridge the gap between complex logic and exceptional user experiences. Every line of code is an opportunity to innovate, transforming modern web and mobile technologies into seamless digital solutions designed for the future.
            </motion.p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-12">
              {timelineEvents.map((event, index) => (
                ...
                >
                  ...
                  <motion.div
                    whileHover={{ y: -5 }}
                    className="flex-1 flex flex-col card bg-gray-900/80 border border-green-500/20 "
                  >

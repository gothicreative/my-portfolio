          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 gap-16 items-center">
              ...
              >
                ...
                <motion.p
                  variants={fadeInUpVariants}
                  className="text-xl text-green-300 mb-10 max-w-2xl mx-auto leading-relaxed font-mono"
                >
        ...
        <section className="section-padding bg-black/50 backdrop-blur-sm">
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-xl text-green-300 max-w-2xl mx-auto leading-relaxed font-mono">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredProjects.map((project, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -8 }}
                  className="card group cursor-pointer apple-transition bg-gray-900/80 border border-green-500/20 backdrop-blur-sm"
                >
                  ...
                  <h3 className="text-xl font-semibold mb-2 group-hover:text-green-400 transition-colors text-green-300 font-mono">
                    {project.title}
                  </h3>
                  
                  <p className="text-green-200 mb-4 line-clamp-3 font-mono text-sm">
                    {project.description}
                  </p>
                  
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span key={tech} className="tech-badge bg-gray-800 text-green-300 border border-green-500/30 font-mono text-xs">
                        {tech}
                      </span>
                    ))}
                    {project.technologies.length > 3 && (
                      <span className="tech-badge bg-gray-800 text-green-300 border border-green-500/30 font-mono text-xs">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2 py-1 text-xs rounded-full bg-green-900/50 text-green-300 font-mono">
                      {project.platform}
                    </span>
                  </div>
                </motion.div>
            ...
            >
              <Link to="/experience" className="btn-outline border-green-500/50 text-green-300 hover:bg-green-900/30 font-mono">
                &gt; View All Projects
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="text-center bg-gray-900/80 p-6 rounded-2xl border border-green-500/20 backdrop-blur-sm"
                >
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-green-300 font-mono">{category.title}</h3>
                  <ul className="text-green-200 space-y-1 font-mono text-sm">
